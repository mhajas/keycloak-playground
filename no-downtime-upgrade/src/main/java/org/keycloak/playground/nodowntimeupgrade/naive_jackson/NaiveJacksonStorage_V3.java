 ...
 * @author hmlnarik
 */
public class NaiveJacksonStorage_V3 extends AbstractNaiveVersionedJacksonStorage<ObjectModel_V3, ObjectEntity_V3> {

    public NaiveJacksonStorage_V3(ConcurrentMap<String, byte[]> store) {
        super(store, ModelVersion.VERSION_3,
          ObjectModel_V3.class, ObjectEntity_V3::fromModel,
          ObjectEntity_V3.class, ObjectEntity_V3::toModel,
